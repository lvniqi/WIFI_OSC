...
* module SAVE_ADDR
* */
module FIFO2MCU(input clk,input rst_n,
					 input [7:0]data_in,input en,input[7:0] len_in,
	...
	always @ (posedge clk or posedge clk_n or negedge rst_n) begin   
		if(!rst_n) begin 
			current_state <= IDLE;
			end
		else if(clk == 1) begin 
